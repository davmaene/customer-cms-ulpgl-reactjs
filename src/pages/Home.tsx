...
export const Home: React.FC = () => {
  return (
    <div data-rsssl="1" className="home wp-singular page-template page-template-no-title page page-id-11 wp-custom-logo wp-embed-responsive wp-theme-edublock-pro tribe-js">
      ...
      {/* <div id="thunderbit-crx-side-bar" style={{display: 'block', opacity: 1, top: 0, right: 0, zIndex: 9007199254740991, position: 'fixed', pointerEvents: 'none', userSelect: 'none'}}></div> */}
      {/* <button id="open-side-panel" style={{width: 0, height: 0, opacity: 0, userSelect: 'none', pointerEvents: 'all', position: 'absolute', bottom: 0, right: 0, padding: 0, border: 0, outline: 'none'}}></button> */}
    </div>
  );
};
...
const SkipToContent: React.FC = () => {
  return (
    <a className="skip-link screen-reader-text" id="wp-skip-link" href="index.html">
      Skip to content
    </a>
  );
};
...
const FeatureItem: React.FC<{
  ...
  linkText: string;
  linkHref: string;
}> = ({ icon, title, description, linkText, linkHref }) => {
  return (
    <div className="wp-block-column is-style-default is-layout-flow wp-block-column-is-layout-flow"
      style={{borderTopStyle: 'none', borderTopWidth: '0px', borderRightColor: '#6c6c77', borderRightWidth: '1px', borderBottomStyle: 'none', borderBottomWidth: '0px', paddingRight: '5%'}}>
