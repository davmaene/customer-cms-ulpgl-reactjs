...
export const BreadcrumbCenter = ({ category, post_title }: { category: string, post_title: string }) => (
    <div style={{ gap: '.4em' }} className="breadcrumb-block mb-4">
        <nav aria-label="Breadcrumbs">
            <ol className="breadcrumb list-unstyled d-flex m-0">
                ...
                <li className="breadcrumb-item-"><Link to={routes.CENTRES}>Centres de recherche</Link><span className="mx-2 text-muted">/</span></li>
                <li className="breadcrumb-item-"><Link to={routes.ARTICLES.concat("/").concat(category)}>{category}</Link></li>
